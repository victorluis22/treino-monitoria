...
int carregaInicio() {
	...
	printf("\nTente adivinhar a senha escolhida, voce tem 5 tentativas\n");	
...
int analisaSenha(int n) {
	int vencedor = 0, chances = 5, chute;
